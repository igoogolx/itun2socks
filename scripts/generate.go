...
func main() {
	download("https://github.com/igoogolx/lux-geo-data/releases/download/v0.0.5/geoData.tar.gz", filepath.Join("pkg", "geo", "geoData.tar.gz"))
	download("https://github.com/igoogolx/lux-client/releases/download/v0.6.3/dist-ui.tar.gz", filepath.Join("api", "routes", "dist.tar.gz"))
}
